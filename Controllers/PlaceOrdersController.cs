...
using TaxSystemNASS.Controllers.Utilities;
...
namespace TaxSystemNASS.Controllers
{
    public class PlaceOrdersController : Controller
    {
        ...
        //TODO: Finish reviews
        [HttpPost]
        public async Task<IActionResult> ReviewPurchased(string BuyFNameText, string BuyMIText, string BuyLNameText, string BuyDOBText, string BuySSNText, string BuyEmailText, string BuyPhoneText, string BuyFaxText, string SellFNameText, string SellMIText, string SellLNameText,
            ...
            string SellCounty, string SellCity, string SellParcel, string PropAddrLn1, string PropAddrLn2, string PropState, string PropZip,
            string PropCounty, string PropCity, string PropParcel, string ProductSold)
        {
            ...
            ViewData["SellParcel"] = SellParcel;
        ...
        public IActionResult ReviewRefi(string RefiFNameText, string RefiMIText, string RefiLNameText, string RefiDOBText, string RefiSSNText, string RefiEmailText, string RefiPhoneText, string RefiFaxText, string RefiAddrLn1, string RefiAddrLn2, string RefiState, string RefiZip, string RefiCounty, string RefiCity, string RefiParcel, string ProductSold)
        {
            ...
            sqlProcedureExecute.AppendFormat(@"@RefiMIText = '{0}', @RefiLNameText = '{1}', @RefiFNameText = '{2}', @RefiDOBText = '{3}', @RefiSSNText = '{4}', @RefiEmailText = '{5}', @RefiPhoneText = '{6}', @RefiFaxText = '{7}', @RefiAddrLn1 = '{8}', @RefiAddrLn2 = '{9}', @RefiState = '{10}', @RefiZip = '{11}', @RefiCounty = '{12}', @RefiCity = '{13}', @RefiParcel = '{14}', @Product = '{15}', @Date = '{16}'", RefiFNameText, RefiMIText, RefiLNameText, RefiDOBText, RefiSSNText, RefiEmailText, RefiPhoneText, RefiFaxText, RefiAddrLn1, RefiAddrLn2, RefiState, RefiZip, RefiCounty, RefiCity, RefiParcel, ProductSold, DateTime.Today);
